...
class Helical_FactorIntFunc : public FactorIntFunc
{
    ...
    public:
        // constructors
        Helical_FactorIntFunc( double _distThr, double _distance_offset, double _orientationEffect = 1.0 ) : FactorIntFunc(_distThr, _orientationEffect), distance_offset( _distance_offset )
        {}
